                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="cadconsultas.php" method="POST">
                                            ...
                                            <input type="text" class="form-control" name="descripcao" placeholder="" />
                                            <br />

                                            <label>Situação Consulta</label>
                                            <select class="form-select" aria-label="Default select example "
                                                name="situacao">
                                                <option selected>Selecione o Status da Consulta</option>
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                placeholder="Insira titulo do evento" required />
                                            <br />
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="cadconsultas.php" method="POST">
                                            ...
                                            <label>Descrição da Consulta</label>
                                            <input type="text" class="form-control form-select-sm" name="descripcao" placeholder="" />
                                            <br />
